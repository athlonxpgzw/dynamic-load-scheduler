...
import (
	...
	policy "github.com/athlonxpgzw/dynamic-load-scheduler/pkg/apis/policy"

	prom "github.com/athlonxpgzw/dynamic-load-scheduler/pkg/controller/prometheus"
	utils "github.com/athlonxpgzw/dynamic-load-scheduler/pkg/utils"
)
...
func annotateNodeLoad(promClient prom.PromClient, kubeClient clientset.Interface, node *v1.Node, key string) error {
	...
	if err != nil || len(value) == 0 {
		value, err = promClient.QueryByInstanceName(key, node.Name)
		if err != nil || len(value) == 0 {
